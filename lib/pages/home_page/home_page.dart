...
import 'package:superhero/api/api_connection.dart';
...
class _HomePageState extends State<HomePage>
  ...
  Future<void> getAllHeroesList() async {
    superHeroList = await getAllHeroes();
              ...
              children: [
                SwipeCards(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    HeroInfo item = superHeroList[index];
                                        ...
                                        onChanged: (text) {
                                          ...
                                          if (superHeroList.isNotEmpty) {
                                            for (int i = 0;
                                                ...
                                                i++) {
                                              String heroName = superHeroList[i]
                                                  .name
                                                  .toLowerCase();
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            HeroInfo item = superHeroSuggestionList[index];
